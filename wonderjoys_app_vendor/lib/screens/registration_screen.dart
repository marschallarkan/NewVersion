  ...
  Widget _formField({TextEditingController? controller, String? label,TextInputType? type,String? Function(String?)? validator}){
    return TextFormField(
      ...
      decoration: InputDecoration(
        labelText: label,
        prefixText: controller == _contactNumber ? '+39' : null,
      ),
      validator:validator ,
      onChanged: (value){
...
_saveToDB(){
  ...
  if(_formKey.currentState!.validate()){
    ...
    _services.uploadImage(_shopImage, 'vendors/${_services.user!.uid}/_shopImage.jpg').then((String? url){
      if(url!=null){
        setState(() {
          _shopImageUrl = url;
        });
